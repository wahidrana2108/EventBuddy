    ...
    <div class="card glass-card border-0 shadow-lg" style="width: 500px;">
        ...
        <div class="card-body p-3 ">
            <form id="registrationForm" method="POST" action="" enctype="multipart/form-data">
                ...
                <button type="submit" id="registerButton" name="registerButton" class="btn btn-dark w-100" disabled>Register</button>
            </form>
...
<?php 
    if(isset($_POST["registerButton"])){
        ...
        if ($count_users > 0) {
            ...
            echo "<script>alert('This Email is not Register')</script>";
        }
    }
?>